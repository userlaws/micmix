...
app.whenReady().then(async () => {
  ...
  if (!diagnose) {
    ui = new BrowserWindow({ width: 1400, height: 920, minWidth: 960, minHeight: 680,
      title: 'MicMix', backgroundColor: '#0f1116', autoHideMenuBar: true, icon: path.join(__dirname, 'brand', 'icon.png'),
      titleBarStyle: 'hidden', titleBarOverlay: { color: '#0f1116', symbolColor: '#c9d0dc', height: 40 },
