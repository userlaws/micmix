...
## Current state
- Phase 0 implemented; STOPPED at its checkpoint pending user confirmation of CABLE endpoints.
...
- CABLE Input and CABLE Output both missing; checkpoint has NOT passed. No auditory result has been tested or confirmed.
...
- User must install standard VB-CABLE for development and reboot, then rescan. Bundled installer remains Phase 5.
